...
ASK_ITEM_CONFIRMATION = 'You\'re adding an item with name {name}, ' \
                        'description {description} and price {price} BTC. Proceed?'
...
CARD_ITEM = '{n}. {name}, the price is {price} BTC'
EMPTY_CART_SUCCESS = 'Your cart is now empty.'

# Checkout part
CART_IS_EMPTY = 'Your cart is empty'
ASK_FOR_ADDRESS = 'Please, provide your address.'
ADDRESS_SET_ASK_PAYMENT_CONFIRM = 'Address set. You are paying {total_price} BTC for {n} items. ' \
                                  'Your balance is {balance} BTC. Proceed?'
